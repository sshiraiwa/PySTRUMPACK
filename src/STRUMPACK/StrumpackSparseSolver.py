...
class StrumpackSolverBase(object):
    ...
    def reorder_regular(self, nx, ny, nz, components=1, width=1):
        return _StrumpackSparseSolver.StrumpackSolverBase_reorder_regular(self, nx, ny, nz, components, width)
...
STRUMPACK_BLR_HODLR = _StrumpackSparseSolver.STRUMPACK_BLR_HODLR
STRUMPACK_ZFP_BLR_HODLR = _StrumpackSparseSolver.STRUMPACK_ZFP_BLR_HODLR
...
STRUMPACK_AMD = _StrumpackSparseSolver.STRUMPACK_AMD
STRUMPACK_MMD = _StrumpackSparseSolver.STRUMPACK_MMD
STRUMPACK_AND = _StrumpackSparseSolver.STRUMPACK_AND
STRUMPACK_MLF = _StrumpackSparseSolver.STRUMPACK_MLF
STRUMPACK_SPECTRAL = _StrumpackSparseSolver.STRUMPACK_SPECTRAL
...
STRUMPACK_ZERO_PIVOT = _StrumpackSparseSolver.STRUMPACK_ZERO_PIVOT
STRUMPACK_NO_CONVERGENCE = _StrumpackSparseSolver.STRUMPACK_NO_CONVERGENCE
STRUMPACK_INACCURATE_INERTIA = _StrumpackSparseSolver.STRUMPACK_INACCURATE_INERTIA
